...
.Select(x => new RiskDetailModel()
{
    ...
    CustomerDetails = new CustomerModel { FirstName = x.FirstName, LastName = x.LastName, PhoneNumber = x.PhoneNumber, EmailAddress = x.Email }
        ...
        public ActionResult DailyReceiptsReport()
        {
            ...
            var query = "select  DISTINCT  VehicleDetail.PolicyId as PId,VehicleDetail.Id as VehicleId, VehicleDetail.RenewPolicyNumber as VehileRenewPolicyNum, ";
            query += " VehicleDetail.TransactionDate, [dbo].[fn_GetUserCallCenterAgent] (SummaryDetail.CreatedBy) as Agent, VehicleDetail.[CurrencyId], VehicleDetail.RadioLicenseCost as RadioCost, VehicleDetail.VehicleLicenceFee as ZinaraFee, ReceiptModuleHistory.*, Customer.FirstName +' ' + Customer.LastName as PolicyCreatedBy from ReceiptModuleHistory ";
            ...
            query += "join VehicleDetail  on ReceiptModuleHistory.PolicyId=VehicleDetail.PolicyId where VehicleDetail.IsActive=1";
        ...
        public ActionResult ReconciliationReport()
        {
            ...
            var query1 = "select top 100 PolicyDetail.PolicyNumber,VehicleDetail.RenewPolicyNumber, createcust.FirstName + '' + createcust.LastName as Created, prcustomer.FirstName + ' ' + prcustomer.LastName as CustomerName, SummaryDetail.CreatedOn as TransactionDate,";
        ...
        public ActionResult ReconciliationSearchReport(DailyReceiptsSearchReportModel Model)
        {
            ...
            var query1 = "select PolicyDetail.PolicyNumber,VehicleDetail.RenewPolicyNumber, createcust.FirstName + '' + createcust.LastName as Created, prcustomer.FirstName + ' ' + prcustomer.LastName as CustomerName,   SummaryDetail.CreatedOn TransactionDate,";
            ...
            query1 += " left join Branch on VehicleDetail.ALMBranchId= Branch.Id ";
            query1 += " where VehicleDetail.IsActive=1 and SummaryDetail.isQuotation=0 ";
        ...
        public ActionResult DailyReceiptsSearchReport(DailyReceiptsSearchReportModel Model)
        {
            ...
            query += " VehicleDetail.TransactionDate,[dbo].[fn_GetUserCallCenterAgent] (SummaryDetail.CreatedBy) as Agent, VehicleDetail.RenewPolicyNumber as VehileRenewPolicyNum, VehicleDetail.[CurrencyId], ReceiptModuleHistory.*,  VehicleDetail.RadioLicenseCost as RadioCost, VehicleDetail.VehicleLicenceFee as ZinaraFee, Customer.FirstName +' ' + Customer.LastName as PolicyCreatedBy from ReceiptModuleHistory ";
            query += " join SummaryDetail on ReceiptModuleHistory.SummaryDetailId = SummaryDetail.id ";
            //query += " join Customer on SummaryDetail.CreatedBy = Customer.Id";
            query += "Left join Customer  on ReceiptModuleHistory.CreatedBy = Customer.Id ";
            ...
            model.DailyReceiptsReport = newList.Where(c => c.DatePosted >= Convert.ToDateTime(Model.FromDate) && c.DatePosted <= Convert.ToDateTime(Model.EndDate)).OrderByDescending(c => c.DatePosted).ToList();
